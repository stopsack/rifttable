...
The `breastcancer` dataset of a binary outcome is included in the rifttable package:
```{r data1}
data(breastcancer)
...
This example also adds an overall estimate not stratified by exposure.
